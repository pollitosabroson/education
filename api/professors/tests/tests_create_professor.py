...
from .factorial import ProfessorFactory
...
        have a fail answer
        """
        duplicate_email = 'hola@hola.com'
        ProfessorFactory.get_professor(
    ...
    def test_success(self, client):
        ...
        for fixtures in self.get_success_fixtures():
            ...
            assert conf_schema_professor.validate(response_content)
            assert conf_schema_professor.is_valid(response_content)
